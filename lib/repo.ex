defmodule NewsService.Repo do
    use Ecto.Repo,
    otp_app: :news_service,
...
defmodule NewsService.Eventing.Repo do
  alias NewsService.Repo
  # alias NewsService.{Build, Step, Log}
  # alias NewsService.{BranchUpdaterChannel, BuildUpdaterChannel,
  #                     StepUpdaterChannel}
  ...
  defp model_event(_model, _mode) do
    # Que.add(NewsService.Workers.SchemaUpdatedWorker, [model, mode])
  end
end
